...
ARG LIBVA_VERSION=2.7.1
ARG INTEL_VAAPI_DRIVER_VERSION=2.4.0
ARG GMMLIB_VERSION=20.1.1
ARG INTEL_MEDIA_DRIVER_VERSION=20.1.1
ARG INTEL_MEDIA_SDK_VERSION=20.1.1
...
ENV APP_NAME="HandBrake" \
    AUTOMATED_CONVERSION_PRESET="TVE/PAL" \
